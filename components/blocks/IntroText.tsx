  ...
  return (
    <section className="w-full bg-transparent">
      <div className="mx-auto flex w-full max-w-[1900px] flex-col items-center px-4 py-12 text-center md:px-8 md:py-20">
        {eyebrow && (
          <p className="mb-8 text-sm font-medium text-primary lg:text-base reveal">
            {eyebrow}
          </p>
        )}
        {heading && (
          <h2 className={cn("max-w-[1200px] font-display text-4xl uppercase text-primary md:text-5xl lg:text-6xl reveal",
